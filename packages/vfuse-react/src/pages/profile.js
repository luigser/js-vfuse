...
export default function ProfilePage(props){
    ...
    const [signalServer, setSignalServer] = useState('/dns4/172.16.149.100/tcp/2002/wss/p2p-webrtc-star/')
    const [delegateNode, setDelegateNode] = useState('')
    const [pinningServerProtocol, setPinningServerProtocol] = useState('https')
    const [pinningServerHost, setPinningServerHost] = useState('172.16.149.100')
    const [pinningServerPort, setPinningServerPort] = useState('9097')
    const [bootstraps, setBootstrap] = useState(['/ip4/172.16.149.100/tcp/4002/wss/p2p/12D3KooWFm8MiFfXCGyj1ZiJZevYcnFUiWcQqAmYQVEeJqckwkww'])
    const [bootstrapsString, setBootstrapString] = useState('/ip4/172.16.149.100/tcp/4002/wss/p2p/12D3KooWFm8MiFfXCGyj1ZiJZevYcnFUiWcQqAmYQVEeJqckwkww')
